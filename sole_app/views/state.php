...
<html lang="en">
	...
	<body>			
				...
				<div class="row">
					...
					<div class="fourcol last">
						<div id="header_types">
							...
							<a href="<?php echo site_url('main/state'); ?>" class="btn medium_btn green" id="state_button">State</a>
		...
		<div id="main_loading">Loading states..<img src="images/main_loader.gif" /></div>
		<script type="text/coffeescript" src="js/sole/State.coffee"></script>
		...
		<script id="user_hb" type="text/x-handlebars-template">
			<div class="user">
				...
				<div class="profile_box">
					...
					<div class="info">
						Total of {{format_num num_users}} StackOverflow users in this state
					</div>
				</div>
			</div>
		</script>

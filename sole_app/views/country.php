...
<html lang="en">
	...
	<body>			
				...
				<div class="row">
					...
					<div class="fourcol last">
						<div id="header_types">
							...
							<a href="<?php echo site_url('main/country'); ?>" class="btn medium_btn green" id="country_button">Country</a>
		...
		<div id="main_loading">Loading countries..<img src="images/main_loader.gif" /></div>
		<script type="text/coffeescript" src="js/sole/Country.coffee"></script>
		...
		<script id="user_hb" type="text/x-handlebars-template">
			<div class="user">
				...
				<div class="profile_box">
					...
					<div class="info">
						Total of {{format_num num_users}} StackOverflow users in this country
					</div>
				</div>
			</div>
		</script>
